...
<article class="post">
	...
	<ol class="alt">
		<li><a href="#introduction" class="scrolly">Introducción</a></li>
		<li><a href="#context" class="scrolly">Contexto</a></li>
		<li><a href="#method" class="scrolly">Metodología</a></li>
		<li><a href="#results" class="scrolly">Resultados</a></li>
		<li><a href="#conclusion" class="scrolly">Conclusión</a></li>
  ...
  <span class="image left">
    <img src="{{'/images/pic02.jpg' | absolute_url}}" alt>
  </span>
  In fermentum posuere urna nec tincidunt praesent semper. At volutpat diam ut venenatis tellus in metus. Quis imperdiet massa tincidunt nunc. Et sollicitudin ac orci phasellus egestas tellus rutrum tellus pellentesque. Etiam sit amet nisl purus in mollis nunc sed id. Amet est placerat in egestas erat imperdiet sed. Pharetra et ultrices neque ornare aenean euismod. Scelerisque viverra mauris in aliquam sem fringilla. Accumsan tortor posuere ac ut. Nibh praesent tristique magna sit amet purus gravida quis. Vulputate sapien nec sagittis aliquam malesuada bibendum arcu vitae elementum. Convallis aenean et tortor at risus viverra adipiscing at in. Eget est lorem ipsum dolor. Id ornare arcu odio ut sem nulla. Proin gravida hendrerit lectus a. Integer vitae justo eget magna fermentum iaculis.
  </p>
  <span class="image fit">
    <img src="{{'/images/pic01.jpg' | absolute_url}}" alt>
  </span>
  <p>
  Nascetur ridiculus mus mauris vitae ultricies. Nullam vehicula ipsum a arcu cursus. Quisque egestas diam in arcu. Tincidunt augue interdum velit euismod. Scelerisque purus semper eget duis at tellus at urna. Volutpat commodo sed egestas egestas fringilla phasellus. Commodo nulla facilisi nullam vehicula ipsum a. Tristique nulla aliquet enim tortor at auctor urna nunc. Bibendum ut tristique et egestas quis ipsum suspendisse ultrices. Etiam dignissim diam quis enim lobortis scelerisque fermentum. Venenatis cras sed felis eget velit aliquet sagittis. Sit amet cursus sit amet dictum sit amet. In vitae turpis massa sed. Id neque aliquam vestibulum morbi blandit cursus risus at ultrices. Praesent tristique magna sit amet. Egestas dui id ornare arcu odio ut sem nulla.
  </p>
  <!-- /CONTEXT -->
  <!-- METHODOLOGY -->
  <header>
    <h3 id="method">Metodología</h3>
    <p><a href="#title" class="scrolly">Volver al inicio</a></p>
  </header>
  <p>
  ...
  <p>
  Arcu risus quis varius quam. Diam ut venenatis tellus in metus. Rutrum tellus pellentesque eu tincidunt tortor aliquam nulla facilisi cras. Gravida rutrum quisque non tellus. Elementum nisi quis eleifend quam adipiscing. Vel facilisis volutpat est velit egestas. Phasellus egestas tellus rutrum tellus pellentesque eu tincidunt tortor aliquam. Congue quisque egestas diam in arcu cursus euismod quis viverra. Commodo elit at imperdiet dui. Porttitor eget dolor morbi non arcu risus. Mauris rhoncus aenean vel elit scelerisque. Nulla aliquet enim tortor at auctor urna nunc.
  </p>
  {% highlight python %}
import h5py
import numpy as np
