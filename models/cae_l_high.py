...
class CAEModel(BaseModel):
    ...
    def build_model(self):
        ...
        with tf.name_scope("encoder"):
            l1 = tf.layers.conv2d(inputs=self.x, filters=4, kernel_size=(3,3), padding='same', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="e_conv1")
            ...
            # now 64x64x4
            l3 = tf.layers.conv2d(inputs=l2, filters=8, kernel_size=(3,3), padding='same', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="e_conv2")
            ...
            # now 32x32x8
            l5 = tf.layers.conv2d(inputs=l4, filters=16, kernel_size=(3,3), padding='same', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="e_conv3")
            ...
            # now 16x16x16
            l7 = tf.layers.conv2d(inputs=l6, filters=32, kernel_size=(3,3), padding='same', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="e_conv4")
            ...
            # now 8x8x32
            l9 = tf.layers.conv2d(inputs=l8, filters=64, kernel_size=(3,3), padding='same', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="e_conv5")
            ...
            # now 4x4x64
            l11 = tf.layers.conv2d(inputs=l10, filters=128, kernel_size=(3,3), padding='same', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="e_conv6")
            ...
            # now 2x2x128
            l13 = tf.layers.conv2d(inputs=l12, filters=256, kernel_size=(3,3), padding='same', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="e_conv7")
            ...
            # now 1x1x256
        self.encoded = tf.layers.conv2d(inputs=l14, filters = 512, kernel_size=(3,3), padding='same', name='encoded')
        d15= tf.nn.dropout(self.encoded, self.config.keep_prob, name="encoded_drop")
        # now 1x1x512
        with tf.name_scope("decoder"):
            dl15 = tf.layers.conv2d(inputs=d15, filters=256, kernel_size=(3,3), padding='same', name='d_conv1')
            ...
            # now 2x2x256
            l17 = tf.layers.conv2d(inputs=l16, filters=128, kernel_size=(3,3), padding='same', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="d_conv2")
            ...
            # now 4x4x128
            l19 = tf.layers.conv2d(inputs=l18, filters=64, kernel_size=(3,3), padding='same', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="d_conv3")
            ...
            # now 8x8x64
            l21 = tf.layers.conv2d(inputs=l20, filters=32, kernel_size=(3,3), padding='same', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="d_conv4")
            ...
            # now 16x16x32
            l23 = tf.layers.conv2d(inputs=l22, filters=16, kernel_size=(3,3), padding='same', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="d_conv5")
            ...
            # now 32x32x16
            l25 = tf.layers.conv2d(inputs=l24, filters=8, kernel_size=(3,3), padding='same', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="d_conv6")
            ...
            # now 64x64x8
            l27 = tf.layers.conv2d(inputs=l26, filters=4, kernel_size=(3,3), padding='same', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="d_conv7")
            ...
            # now 128x128x4
        self.decoded = tf.layers.conv2d(inputs=l28, filters=1, kernel_size=(3,3), padding='same', activation=tf.nn.relu, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="decoded")
        # now 128x128x1
