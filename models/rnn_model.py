...
class RNNModel(BaseModel):
    ...
    def build_model(self):
        ...
        enc_max = [32.72663116455078,8.7772855758667,81.73662567138672,46.63551712036133,30.93536949157715,0.9027136564254761,66.04371643066406,67.35106658935547,36.75901412963867,11.51897144317627,51.02521896362305,46.63236618041992,33.83308410644531,19.863624572753906,72.692626953125,43.59470748901367]
        enc_mean = [4.461085319519043,-9.29656982421875,14.543147087097168,2.361961603164673,6.676889419555664,-12.098401069641113,24.03343391418457,9.336644172668457,5.314021110534668,-7.672455787658691,7.461145401000977,8.348762512207031,2.163285493850708,-2.1502020359039307,9.220654487609863,3.469447374343872]
        ...
        l1 = tf.contrib.layers.fully_connected(output, 256, activation_fn=tf.nn.sigmoid)
